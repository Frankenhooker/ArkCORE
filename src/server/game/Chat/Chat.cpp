...
ChatCommand * ChatHandler::getCommandTable ()
{
    ...
    {
    { "chat", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGMChatCommand>, "", NULL },
    { "fly", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGMFlyCommand>, "", NULL },
    ...
    { "visible", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGMVisibleCommand>, "", NULL },
    { "", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGMCommand>, "", NULL },
    { NULL, 0, false, NULL, "", NULL } };

    static ChatCommand goCommandTable[] =
    {
    { "creature", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGoCreatureCommand>, "", NULL },
    { "graveyard", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGoGraveyardCommand>, "", NULL },
    { "grid", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGoGridCommand>, "", NULL },
    { "object", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGoObjectCommand>, "", NULL },
    { "taxinode", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGoTaxinodeCommand>, "", NULL },
    { "trigger", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGoTriggerCommand>, "", NULL },
    { "zonexy", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGoZoneXYCommand>, "", NULL },
    { "xy", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGoXYCommand>, "", NULL },
    { "xyz", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGoXYZCommand>, "", NULL },
    { "ticket", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGoTicketCommand>, "", NULL },
    { "", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGoXYZCommand>, "", NULL },
    { NULL, 0, false, NULL, "", NULL } };
    ...
    { "all_default", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleLearnAllDefaultCommand>, "", NULL },
    { "all_lang", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleLearnAllLangCommand>, "", NULL },
    ...
    {
    { "hp", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyHPCommand>, "", NULL },
    { "mana", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyManaCommand>, "", NULL },
    { "rage", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyRageCommand>, "", NULL },
    { "runicpower", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyRunicPowerCommand>, "", NULL },
    { "energy", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyEnergyCommand>, "", NULL },
    { "money", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyMoneyCommand>, "", NULL },
    { "speed", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifySpeedCommand>, "", NULL },
    { "swim", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifySwimCommand>, "", NULL },
    { "scale", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyScaleCommand>, "", NULL },
    { "bit", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyBitCommand>, "", NULL },
    { "bwalk", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyBWalkCommand>, "", NULL },
    { "fly", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyFlyCommand>, "", NULL },
    { "aspeed", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyASpeedCommand>, "", NULL },
    { "faction", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyFactionCommand>, "", NULL },
    { "spell", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifySpellCommand>, "", NULL },
    { "tp", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyTalentCommand>, "", NULL },
    { "mount", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyMountCommand>, "", NULL },
    { "currency", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyCurrencyCommand>, "", NULL },
    { "rep", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyRepCommand>, "", NULL },
    { "drunk", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleModifyDrunkCommand>, "", NULL },
    ...
    { "name", SEC_GAMEMASTER, true, OldHandler<&ChatHandler::HandleTeleNameCommand>, "", NULL },
    { "group", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleTeleGroupCommand>, "", NULL },
    { "", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleTeleCommand>, "", NULL },
    { NULL, 0, false, NULL, "", NULL } };
    ...
    {
    { "list", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketListCommand>, "", NULL },
    { "onlinelist", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketListOnlineCommand>, "", NULL },
    { "viewname", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketGetByNameCommand>, "", NULL },
    { "viewid", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketGetByIdCommand>, "", NULL },
    { "close", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketCloseByIdCommand>, "", NULL },
    ...
    { "complete", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGMTicketCompleteCommand>, "", NULL },
    { NULL, 0, false, NULL, "", NULL } };
    ...
    {
    { "gm", SEC_CONTENTTESTER, true, NULL, "", gmCommandTable },
    { "go", SEC_TESTGAMEMASTER, false, NULL, "", goCommandTable },
    ...
    { "ticket", SEC_TESTGAMEMASTER, false, NULL, "", ticketCommandTable },
    ...
    { "nameannounce", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleNameAnnounceCommand>, "", NULL },
    { "gmnameannounce", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleGMNameAnnounceCommand>, "", NULL },
    ...
    { "appear", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleAppearCommand>, "", NULL },
    ...
    { "whispers", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleWhispersCommand>, "", NULL },
    ...
    { "freeze", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleFreezeCommand>, "", NULL },
    { "unfreeze", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleUnFreezeCommand>, "", NULL },
    { "listfreeze", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleListFreezeCommand>, "", NULL },
    { "root", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleFreezeCommand>, "", NULL },
    { "unroot", SEC_TESTGAMEMASTER, false, OldHandler<&ChatHandler::HandleUnFreezeCommand>, "", NULL },
    { "listroot", SEC_GAMEMASTER, false, OldHandler<&ChatHandler::HandleListFreezeCommand>, "", NULL },
